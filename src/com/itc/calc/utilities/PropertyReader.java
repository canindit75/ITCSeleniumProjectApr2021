...
public class PropertyReader {
	...
	public static String ReadProperty(String PropertyName) throws IOException{
		...
		inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/com/itc/calc/config/config.properties");
		prop = new Properties();
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println(PropertyReader.ReadProperty("browsertype"));
	}
}
